...
(function () {
    // Served at /admin/ by the existing backend, so ports and CORS stay aligned.
    ...
    async function request(path, options = {}) {
        ...
        try {
            ...
            throw new Error(
                "Cannot connect to the TrekMate backend. Open this panel at the running backend's /admin/ address."
            );
        }
