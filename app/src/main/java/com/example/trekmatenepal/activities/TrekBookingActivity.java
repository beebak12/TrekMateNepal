...
public class TrekBookingActivity extends AppCompatActivity {
    ...
    private TextView txtDifficultyTag;
    private TextView txtTrekNameHero;
    private TextView txtLocationHero;
    private TextView txtAltitude;
    private TextView txtDuration;
    private TextView txtDistance;
    private TextView txtRatingScore;
    private TextView txtAbout;
    private TextView txtTrekFee;

    private Button btnJoinTrek;
    private Button btnMessageOrganizer;
    ...
    private void initializeViews() {
        imgTrekHero =
                findViewById(R.id.imgTrekHero);

        btnBack =
                findViewById(R.id.btnBack);

        txtDifficultyTag =
                findViewById(R.id.txtDifficultyTag);

        txtTrekNameHero =
                findViewById(R.id.txtTrekNameHero);

        txtLocationHero =
                findViewById(R.id.txtLocationHero);
        ...
        txtRatingScore =
                findViewById(R.id.txtRatingScore);

        txtAbout =
                findViewById(R.id.txtAbout);

        txtTrekFee =
                findViewById(R.id.txtTrekFee);

        btnJoinTrek =
                findViewById(R.id.btnJoinTrek);

        btnMessageOrganizer =
                findViewById(R.id.btnMessageOrganizer);
    }
    ...
    private void setupClickListeners() {
        ...
        btnJoinTrek.setOnClickListener(view -> {
            Intent intent = new Intent(
                    TrekBookingActivity.this,
                    PaymentActivity.class
            );

            intent.putExtra(
                    "name",
                    txtTrekNameHero.getText().toString()
            );

            intent.putExtra(
                    "price",
                    txtTrekFee.getText().toString()
            );
        ...
        btnMessageOrganizer.setOnClickListener(view -> {
            Intent intent = new Intent(
                    TrekBookingActivity.this,
                    ChatActivity.class
            );
    ...
    private void getDataFromIntent() {
        ...
        if (intent != null) {
            ...
            styleDifficultyTag(difficulty);
        }
    }

    private void styleDifficultyTag(String difficulty) {
        if (difficulty == null) {
            return;
        }

        if (difficulty.equalsIgnoreCase("Easy")) {
            txtDifficultyTag.setBackgroundTintList(
